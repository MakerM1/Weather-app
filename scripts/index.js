...
function updateUI(weatherData) {
    ...
    const weatherIndiator = document.getElementById('weather-indicator')
...
const elements2 = document.querySelector('.cardElement2')
...
searchBtn.addEventListener("click", () => {
  ...
  getWeatherData(location)
    ...
    card.style.animation = 'open 0.6s ease-in-out 1'
    card.style.height = '500px'
    elements2.classList.add('active')
});
